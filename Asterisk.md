...
$$
\mathbb{F}(x) = \operatorname{sgn}(x) 
\begin{cases} 
\dfrac{A|x|}{1+\ln(A)}, & |x| < \dfrac{1}{A} \\[10pt] 
...
$$
F(x) = \operatorname{sgn}(x) \dfrac{\ln(1+\mu |x|)}{\ln(1+\mu)}, \quad -1 \leq x \leq 1, \quad (1.2)
$$
...
*Рис 4.2. Размещение файла с приватным ключом в формате ppk*
...
*Рис 4.3. Указание пути к сконвертированному файлу приватного ключа в формате ppk.*
...
*Рис 4.4. Настройка параметров подключения*
...
*Рис 4.5. Схема взаимодействия компонентов инфраструктуры PKI*
